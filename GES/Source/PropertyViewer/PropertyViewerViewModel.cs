namespace GES.Source.PropertyViewer
{
    ...
    public class PropertyViewerViewModel : ToolViewModel
    {
        ...
        private PropertyViewerViewModel() : base("Property Viewer")
        {
            ...
            {
                propertyInfo.SetValue(this.propertyGrid, DarkBrushes.GESColorPanel, null);
            }

            this.propertyGrid.BackColor = DarkBrushes.GESColorPanel;
            this.propertyGrid.CommandsBackColor = DarkBrushes.GESColorPanel;
            this.propertyGrid.HelpBackColor = DarkBrushes.GESColorPanel;
            this.propertyGrid.SelectedItemWithFocusBackColor = DarkBrushes.GESColorPanel;
            this.propertyGrid.ViewBackColor = DarkBrushes.GESColorPanel;

            this.propertyGrid.CommandsActiveLinkColor = DarkBrushes.GESColorPanel;
            this.propertyGrid.CommandsDisabledLinkColor = DarkBrushes.GESColorPanel;

            this.propertyGrid.CategorySplitterColor = DarkBrushes.GESColorWhite;

            this.propertyGrid.CommandsBorderColor = DarkBrushes.GESColorFrame;
            this.propertyGrid.HelpBorderColor = DarkBrushes.GESColorFrame;
            this.propertyGrid.ViewBorderColor = DarkBrushes.GESColorFrame;

            this.propertyGrid.CategoryForeColor = DarkBrushes.GESColorWhite;
            this.propertyGrid.CommandsForeColor = DarkBrushes.GESColorWhite;
            this.propertyGrid.DisabledItemForeColor = DarkBrushes.GESColorWhite;
            this.propertyGrid.HelpForeColor = DarkBrushes.GESColorWhite;
            this.propertyGrid.SelectedItemWithFocusForeColor = DarkBrushes.GESColorWhite;
            this.propertyGrid.ViewForeColor = DarkBrushes.GESColorWhite;
