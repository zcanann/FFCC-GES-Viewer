namespace GES.Engine.Scanning.Scanners.Pointers
{
    using GES.Engine.Common;
    using GES.Engine.Common.Extensions;
    using GES.Engine.Common.Logging;
    using GES.Engine.Scanning.Scanners.Comparers.Vectorized;
    using GES.Engine.Scanning.Scanners.Constraints;
    using GES.Engine.Scanning.Scanners.Pointers.SearchKernels;
