namespace GES.Engine.Memory.Clr
{
    ...
    public class DotNetObjectCollector
    {
        ...
        protected void OnUpdate(CancellationToken cancellationToken)
        {
            ...
            IProxyService proxyService = proxyCommunicator.GetProxyService(GES.Engine.Engine.GetInstance().Processes.IsOpenedProcess32Bit());
