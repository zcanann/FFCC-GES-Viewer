namespace GES.Engine.Memory.Windows.PEB
{
    using GES.Engine.Common.Extensions;
    using System;
    using System.Collections.Generic;
    using System.Diagnostics;
    using System.Linq;
    using static GES.Engine.Memory.Windows.Native.Enumerations;
    using static GES.Engine.Memory.Windows.Native.NativeMethods;
    using static GES.Engine.Memory.Windows.Native.Structures;
    ...
    internal class ManagedPeb
    {
        ...
        private IEnumerable<IntPtr> FindPebs(IntPtr processHandle)
        {
            ...
            // if (Process.Default.IsSelf64Bit() && Processes.Default.IsOpenedProcess32Bit())
            {
