...
Squirrel http-down --url "https://github.com/zcanann/FFCC-GES-Viewer"

$xml = [Xml] (Get-Content .\GES\GES.csproj)
$version = [Version] $xml.Project.PropertyGroup.AssemblyVersion

# build new version and delta updates.
Squirrel pack --framework net7 --packId "GES" --packVersion "$version" --packAuthors "Squalr, Inc." --packDir ".\publish" --icon "GES/AppIcon.ico" # --splashImage "install.gif"`
